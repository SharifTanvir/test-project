                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input id="latitude" type="hidden" class="form-control  @error('latitude') is-invalid @enderror"  name="latitude">
                                <input id="longitude" type="hidden" class="form-control" name="longitude">
                                @error('latitude')
                                <span class="invalid-feedback" role="alert">
                                        <strong>Location permission is needed. Please reload the page.</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
